            ...
            <ul class="list-group list-group-lg list-group-flush">
                ...
                <li class="list-group-item">
                    <div class="row">
                        ...
                        <div class="col-4 cart-img-div d-flex align-items-center justify-content-center">
                            <a href="">
                                <img class="img-fluid cart-img" src="https://www.liveabout.com/thmb/Nvi2qTRdhM6gNNTOptxr6HMqB10=/1250x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/halo-combat-evolved-game-57900ff03df78c09e9a2071e.jpg" alt="product image">
                            </a>    
                        </div>
                        <div class="col-8">
                            <p>
                                <a class="text-muted text-decoration-none" href="">Halo Combat Evolved</a> <br>
                                <span class="text-muted">€60.00</span>
                            </p>
                            <div class="mt-auto mb-0">
                                <!-- PROD COUNTER -->
                                <div class="input-group">
                                    <input type="text" class="form-control cart-input text-center counter input-sm p-0" maxlength="2" value="1">
                ...
                <li class="list-group-item">
                    <div class="row">
                        ...
                        <div class="col-4 cart-img-div d-flex align-items-center justify-content-center">
                            <a href="">
                                <img class="img-fluid cart-img" src="https://i.redd.it/wiu3sxnjxwy51.jpg" alt="product image">
                            </a>    
                        </div>
                        <div class="col-8">
                            <p>
                                <a class="text-muted text-decoration-none" href="">Halo Wombat Evolved</a> <br>
                                <span class="text-muted">€60.00</span>
                            </p>
                            <div class="mt-auto mb-0">
                                <!-- PROD COUNTER -->
