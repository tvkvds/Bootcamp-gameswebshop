@include('.partials.shoppingcart-modal')
...
<nav class="navbar navbar-expand-xl">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navCollapse">
            <!-- LEFT SIDE LINKS -->
            <ul class="navbar-nav">
                <li class="nav-item me-4"><a href="/home">HOME</a></li>
                <li class="nav-item me-4"><a href="/search">SHOP</a></li>
                <li class="nav-item me-4"><a href="">ABOUT</a></li>
            </ul>
            <!-- CENTER CONTENT -->
            <a class="navbar-brand mx-auto d-none d-xl-block" href="/home">City Games</a>
